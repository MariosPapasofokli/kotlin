...
public final class DecompiledDataFactory {
    ...
    @NotNull
    private final KotlinJvmBinaryClass kotlinClass;
    @NotNull
    ...
    private DecompiledDataFactory(@NotNull VirtualFile classFile, @NotNull Project project) {
        ...
        this.kotlinClass = VirtualFileFinder.SERVICE.getInstance(project).createKotlinClass(classFile);
        this.classFqName = kotlinClass.getClassName().getFqNameForClassNameWithoutDollars();

        assert kotlinClass.getClassHeaderData() != null : "Decompiled data factory shouldn't be called on an unsupported file: " + classFile;
    }
